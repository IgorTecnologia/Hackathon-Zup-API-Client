...
public class UserDTO extends RepresentationModel<UserDTO> {
    ...
    @Size(min = 4, max = 50, message = "Minimum characters 4 and maximum 30.", groups = UserView.registrationPost.class)
    @NotBlank(message = "The user name field is mandatory.", groups = UserView.registrationPost.class)
    @JsonView({UserView.registrationPost.class})
    @UsernameConstraint(groups = UserView.registrationPost.class, message = "Invalid username, already exists.")
    ...
    @NotNull(message = "The e-mail field is mandatory.", groups = UserView.registrationPost.class)
    ...
    @NotBlank(message = "The password field is mandatory.", groups = {UserView.registrationPost.class, UserView.passwordPut.class})
    @JsonView({UserView.registrationPost.class, UserView.passwordPut.class})
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)
    private String password;

    @Size(min = 7, max = 70, groups = UserView.passwordPut.class)
    @NotBlank(message = "The Old password field is mandatory.", groups = UserView.passwordPut.class)
    ...
    @Size(min = 9, max = 30, message = "Minimum characters 9 and maximum 20.", groups = {UserView.registrationPost.class, UserView.userPut.class})
    @JsonView({UserView.registrationPost.class, UserView.userPut.class})
    private String phoneNumber;

    @Size(min = 10, max = 30, message = "Minimum characters 10 and maximum 30.", groups = {UserView.registrationPost.class, UserView.userPut.class})
